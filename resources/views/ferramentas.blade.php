            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2" data-bs-toggle="modal" data-bs-target="#prateleiraModel">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Prateleiras
                                </div>
                                <div class="row no-gutters align-items-center">
                                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2" data-bs-toggle="modal" data-bs-target="#cursoModal">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Cursos da Instituição</div>  
                                 <div class="h5 mb-0 font-weight-bold text-gray-800">{{$Cursos->count()}}</div>
                                <ul>  @foreach ($Cursos as $G) <li><span class="text-muted small pt-2 ps-1">{{$G->descricao}}</span> </li>  @endforeach </ul>
